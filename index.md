...
<div id="ai-assistant" style="background: rgba(18, 18, 18, 1); width: 100vw; position: relative; left: 50%; transform: translateX(-50%); padding: 20px 0; display: flex; flex-direction: column; align-items: center;">
  <div class="container" style="width: 95%; max-width: 900px;">
